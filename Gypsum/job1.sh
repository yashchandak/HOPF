#!/bin/bash
#
#SBATCH --job-name=highD_Norm
#SBATCH --output=./stdoutput_1/highD_1_%A_%a.out # output file
#SBATCH --error=./stdoutput_1/highD_1.err        # File to which STDERR will be written
...
srun python /home/ychandak/RL/src/run.py --inc $SLURM_ARRAY_TASK_ID --base 0 --hyper 1
